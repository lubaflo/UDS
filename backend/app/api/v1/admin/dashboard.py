...
def get_full_dashboard(
    ...
    section_links = [
        ...
        DashboardSectionLink(section="appointments", route="/admin/appointments"),
        DashboardSectionLink(section="products", route="/admin/products"),
        DashboardSectionLink(section="news", route="/admin/news"),
        DashboardSectionLink(section="campaigns", route="/admin/campaigns"),
        DashboardSectionLink(section="communications", route="/admin/communications"),
        DashboardSectionLink(section="feedback", route="/admin/feedback"),
        DashboardSectionLink(section="messages", route="/admin/dialogues/messages"),
        DashboardSectionLink(section="traffic_channels", route="/admin/traffic-channels"),
        DashboardSectionLink(section="employees", route="/admin/employees"),
        DashboardSectionLink(section="analytics", route="/admin/analytics/control-tower"),
        DashboardSectionLink(section="system_settings", route="/admin/options/system"),
        DashboardSectionLink(
            section="promotion",
